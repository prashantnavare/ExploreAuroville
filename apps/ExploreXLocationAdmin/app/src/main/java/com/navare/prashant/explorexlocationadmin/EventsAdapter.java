        ...
        public RowViewHolder(View view) {
            ...
            mDeleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mEventListActivity.deleteEvent(mEventList.get(getAdapterPosition()));
                }
            });
            ...
            mRelativeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mEventListActivity.editEvent(mEventList.get(getAdapterPosition()));
                }
            });
        }
    }

    public EventsAdapter(EventListActivity eventListActivity, List<CurrentEvent> eventList){
        this.mEventList = eventList;
        this.mEventListActivity = eventListActivity;
    }
